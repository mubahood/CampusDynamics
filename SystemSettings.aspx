        ...
        <tr>
            <td>
                <table class="style1">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:ObjectDataSource ID="ds_logs" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy_periodicAuditTrail" TypeName="SecurityTableAdapters.acad_activity_logTableAdapter" UpdateMethod="Update">
                                <DeleteParameters>
