<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GradingSystem.ascx.cs" Inherits="UserControls_Faculty_GradingSystem" %>
<style type="text/css">
    .style1
    {
        width: 100%;
...
<dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                        ...
                        <table cellpadding="0" cellspacing="0" class="style1">
                            <tr>
                                <td style="text-align: center">
                                    <dx:ASPxImage ID="ASPxImage1" runat="server" ImageAlign="AbsBottom" ImageUrl="~/COOPERP/images/header_gradingsys_info.png">
                                    </dx:ASPxImage>
                                </td>
                            </tr>
                            <tr>
	...
	gvCourseInfo.Refresh();
                ...
                <tr>
                    <td>
                        <dx:ASPxGridView ID="gvCourseInfo" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvCourseInfo" DataSourceID="dsGradingSysInfo" KeyFieldName="ID" Width="100%">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Grading System Name" FieldName="gs_name" ShowInCustomizationForm="True" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataDateColumn Caption="Start Date" FieldName="gs_startDate" ShowInCustomizationForm="True" VisibleIndex="3">
                                </dx:GridViewDataDateColumn>
                                <dx:GridViewDataTextColumn Caption="Decimal Places" FieldName="gs_decimals" ShowInCustomizationForm="True" VisibleIndex="4">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Comments" FieldName="gs_comments" ShowInCustomizationForm="True" VisibleIndex="5">
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Details" VisibleIndex="6" Width="40px">
                                    <DataItemTemplate>
                ...
                <tr>
                    <td>
                        <asp:ObjectDataSource ID="dsGradingSysInfo" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="ResultsDataTableAdapters.acad_gradingsystemTableAdapter" UpdateMethod="Update">
                            <DeleteParameters>
                                <asp:Parameter Name="Original_ID" Type="UInt32" />
                            </DeleteParameters>
                            <InsertParameters>
                                <asp:Parameter Name="gs_name" Type="String" />
                                <asp:Parameter Name="gs_startDate" Type="DateTime" />
                                <asp:Parameter Name="gs_decimals" Type="Double" />
                                <asp:Parameter Name="gs_comments" Type="String" />
                            </InsertParameters>
                            <SelectParameters>
