<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FeesPaySchedule.aspx.cs" Inherits="COOPERP_financials_FeesPaySchedule" %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="Fees Schedule" Width="100%">
        ...
        <tr>
            <td>
                <table class="dx-justification">
                    ...
                    <tr>
                        <td class="auto-style4">Add To:</td>
                        <td class="auto-style5">
                            <dx:ASPxComboBox ID="txtStyle" runat="server" Height="35px" SelectedIndex="1">
                                <Items>
                                    <dx:ListEditItem Text="Programme" Value="Programme" />
                                    <dx:ListEditItem Text="Semester" Value="Semester" Selected="True" />
                                </Items>
                                <Paddings PaddingLeft="5px" />
                            </dx:ASPxComboBox>
                        </td>
                        <td class="auto-style6">&nbsp;</td>
                        <td>
                            <dx:ASPxButton ID="cmdAdd" runat="server" Height="35px" OnClick="cmdAdd_Click" Text="Add Item" Width="170px">
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            <dx:ASPxComboBox ID="txtItem" runat="server" DataSourceID="dsBillingItems" Height="35px" SelectedIndex="0" TextField="ItemName" TextFormatString="{1}" ValueField="ItemCode">
                                <Paddings PaddingLeft="5px" />
                            </dx:ASPxComboBox>
                        </td>
                        <td class="auto-style6">&nbsp;</td>
                        <td>
                            <dx:ASPxButton ID="cmdPrintSchedule" runat="server" Height="35px" OnClick="cmdPrintSchedule_Click" Text="Print Schedule" Width="170px">
