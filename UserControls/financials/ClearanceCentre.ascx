...
panel_billling.Show();
                            ...
                            <tr>
                                ...
                                <td class="auto-style13">Entry Year:</td>
                                <td class="auto-style10">
                                    <dx:ASPxComboBox ID="txtEntryYear" runat="server" AutoPostBack="True" Height="35px">
                                        <Paddings PaddingLeft="5px" />
                                    </dx:ASPxComboBox>
                                </td>
                                <td style="text-align: left">
...
panel_billling.Show();
                            ...
                            <tr>
                                ...
                                <td class="auto-style10">
                                    <dx:ASPxButton ID="cmdPrintCards" runat="server" Height="35px" Text="Print Cards" Width="170px" OnClick="cmdPrintCards_Click">
                                        <Image IconID="print_printer_16x16">
                                        </Image>
                                    </dx:ASPxButton>
                                </td>
                                <td style="text-align: left">
                                    <dx:ASPxButton ID="cmdExportToExcel" runat="server" Height="35px" OnClick="cmdExportToExcel_Click" Text="Export to Excel" Width="170px">
                                        <ClientSideEvents Click="function(s, e) {	
}" />
                                                    ...
                                                    <td>
                                                        <asp:ObjectDataSource ID="dsClearanceLists" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="StudentAccountingDataTableAdapters.fin_GetClearanceListsTableAdapter">
                                                            <SelectParameters>
                                                                ...
                                                                <asp:ControlParameter ControlID="txtEntryYear" Name="entyear" PropertyName="Value" Type="String" />
                                                            </SelectParameters>
                ...
                <tr>
                    <td>
                        ...
                        <dx:ASPxGridViewExporter ID="GVE_SchoolPay" runat="server" ExportedRowType="All" GridViewID="gvLedger">
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="cmdExportToExcel" />
        </Triggers>
    </asp:UpdatePanel>
        </dx:PanelContent>
</PanelCollection>
