...
<dx:ASPxRoundPanel ID="ASPxRoundPanel2" runat="server" 
                                                        ...
                                                        <td valign="top">
                                                            <table cellpadding="0" class="style1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="style13">
                                                                        <dx:ASPxComboBox ID="txtAcademicYear" runat="server" AutoPostBack="True" Height="35px" OnSelectedIndexChanged="txtClass_SelectedIndexChanged" Width="170px">
                                                                            <Paddings PaddingLeft="5px" />
                                                                        </dx:ASPxComboBox>
                                                                    </td>
                                                                    <td class="auto-style2">SMS Sender:</td>
                                                                    <td class="style16">
                                                                        <dx:ASPxTextBox ID="txtSMSSender" runat="server" Height="35px" Text="Muteesa I Royal University" Width="200px">
                                                                            <Paddings PaddingLeft="5px" />
                                                                        </dx:ASPxTextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="auto-style4">
                                                                        <dx:ASPxComboBox ID="txtSession" runat="server" AutoPostBack="True" Height="35px" OnSelectedIndexChanged="txtClass_SelectedIndexChanged" SelectedIndex="0" Width="350px" DataSourceID="dsstudysessions" TextField="Session" TextFormatString="{0}" ValueField="Session">
                                                                    ...
                                                                    <td class="style13">
                                                                        <dx:ASPxComboBox ID="txtTerm" runat="server" AutoPostBack="True" Height="35px" SelectedIndex="0" Width="170px">
                                                                            <Items>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="auto-style4">
                                                                        <dx:ASPxComboBox ID="txtYear" runat="server" AutoPostBack="True" Height="35px" SelectedIndex="0" Width="350px">
                                                                            <Items>
                                                                                <dx:ListEditItem Selected="True" Text="1" Value="1" />
                                                                                <dx:ListEditItem Text="2" Value="2" />
                                                                                <dx:ListEditItem Text="3" Value="3" />
                                                                    ...
                                                                    <td class="style13">
                                                                        <dx:ASPxDateEdit ID="txtStartDate" runat="server" Height="35px" Width="170px">
                                                                        </dx:ASPxDateEdit>
                                                                    </td>
                                                                    <td class="auto-style2">&nbsp;</td>
                                                                    <td class="style16">
                                                                        <dx:ASPxButton ID="cmdSMS" runat="server" Height="35px" OnClick="cmdSMS_Click" Text="Send SMS" Width="200px">
	...
	panel_billling.Show();
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="auto-style4">
                                                                        <dx:ASPxComboBox ID="txtStat" runat="server" AutoPostBack="True" Height="35px" SelectedIndex="2" Width="350px">
                                                                            <Items>
                                                                    ...
                                                                    <td class="style13">
                                                                        <dx:ASPxDateEdit ID="txtEndDate" runat="server" Height="35px" Width="170px">
                                                                        </dx:ASPxDateEdit>
                                                                    </td>
                                                                    <td class="auto-style2">&nbsp;</td>
                                                                    <td class="style16">
                                                                        <dx:ASPxButton ID="cmdPrintList" runat="server" Height="35px" OnClick="cmdPrintList_Click" Text="Print List" Width="200px">
