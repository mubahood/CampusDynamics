<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceiptDetails.ascx.cs" Inherits="UserControls_Accounts_ReceiptDetails" %>
<style type="text/css">
                        ...
                        <td class="style9">
                            <dx:ASPxComboBox ID="txtPayeeCategory" runat="server" AutoPostBack="True" 
                                ...
                                <Items>
                                    ...
                                    <dx:ListEditItem Text="Donor" Value="Donor" />
                                </Items>
                            </dx:ASPxComboBox>
                        </td>
                        <td class="style5">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <dx:ASPxComboBox ID="txtPayee" runat="server" DataSourceID="dsPayeeAccounts" 
                                TextField="accountName" ValueField="accountCode" 
                                ValueType="System.String" Width="250px" TextFormatString="{1}" 
