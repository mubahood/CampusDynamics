...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" HeaderText="" ShowHeader="False" Width="100%">
    <PanelCollection>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table id="table1" class="style1">
                        ...
                        <tr>
                            <td>
                                <dx:ASPxGridView ID="gvGeneralLedger" runat="server"
                                    AutoGenerateColumns="False"
                                    DataSourceID="dsJournalTransactions"
                                    KeyFieldName="accountcode"
                                    OnHtmlDataCellPrepared="gvGeneralLedger_HtmlDataCellPrepared"
                                    Width="100%"
                                            ...
                                            <table id="table4" class="style1">
                                                <tr>
                                                    <td class="auto-style23">
                                                        <dx:ASPxGridView ID="gvDetails" runat="server"
                                                            AutoGenerateColumns="False"
                                                            DataSourceID="dsDrillDownDetails"
                                                            KeyFieldName="accountcode"
                                                            OnBeforePerformDataSelect="gvDetails_BeforePerformDataSelect"
                                                            OnHtmlDataCellPrepared="gvDetails_HtmlDataCellPrepared"
                                                            Width="100%"
                                                            EnableCallBacks="True">
                                                                        ...
                                                                        <tr>
                                                                            <td class="auto-style23">
                                                                                <dx:ASPxGridView ID="gvDetails" runat="server"
                                                                                    ...
                                                                                    DataSourceID="dsDrillDownDetails"
                                                                                    KeyFieldName="TID"
                                                                                    OnBeforePerformDataSelect="gvDetails_BeforePerformDataSelect1"
                                                                                    OnHtmlDataCellPrepared="gvDetails_HtmlDataCellPrepared"
                                                                                    Width="100%"
                                                                                    EnableCallBacks="True">
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Caption="Date" FieldName="transactionDate" ShowInCustomizationForm="True" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy">
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Caption="DR/CR" FieldName="transactionType" ShowInCustomizationForm="True" VisibleIndex="7" Width="80px">
                                                                                        </dx:GridViewDataTextColumn>

                                                                                        <dx:GridViewDataTextColumn Caption="Amount" FieldName="transaction_amount" ShowInCustomizationForm="True" VisibleIndex="8" Width="120px">
    <DataItemTemplate>
        <%# Eval("transaction_amount") == DBNull.Value || Eval("transaction_amount") == null 
            ? "" 
            : String.Format("{0:N0}", ToDecimal(Eval("transaction_amount"))) %>
    </DataItemTemplate>
    ...
    <CellStyle HorizontalAlign="Right" />
                                                            ...
                                                            <Columns>
                                                                <dx:GridViewDataTextColumn Caption="Account Code" FieldName="accountcode" VisibleIndex="0" Width="150px">
                                                                </dx:GridViewDataTextColumn>

                                                                <dx:GridViewDataTextColumn Caption="Account Name" FieldName="acc_name" VisibleIndex="1">
                                                                </dx:GridViewDataTextColumn>

                                                                <dx:GridViewDataTextColumn Caption="Balance" FieldName="balance" VisibleIndex="2" Width="120px">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="DRBalance" VisibleIndex="7" Width="120px">
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="CRBalance" VisibleIndex="8" Width="120px">
                                            <BatchEditModifiedCellStyle HorizontalAlign="Right">
                                            </BatchEditModifiedCellStyle>
                                            <HeaderStyle HorizontalAlign="Right" />
                                            <CellStyle HorizontalAlign="Right">
                                    ...
                                    <ContentCollection>
                                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                                            <table class="style1">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        &nbsp;<dx:ASPxLabel ID="lbl_msgbox" runat="server" ForeColor="Red" style="font-weight: 700;">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <ContentCollection>
                                        <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                                            <table class="style1">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        &nbsp;<dx:ASPxLabel ID="lbl_msgbox0" runat="server" ForeColor="Red" style="font-weight: 700;">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
