<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VoucherPreview.ascx.cs" Inherits="UserControls_Accounts_VoucherPreview" %>
<style type="text/css">
    .style1
    {
        width: 100%;
...
<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" 
    HeaderText="Voucher Approval" Width="100%">
                                            ...
                                            <tr>
                                                <td class="style17">
                                                    <dx:ASPxButton ID="cmdApprove" runat="server" onclick="cmdApprove_Click" 
                                                        Text="Print Voucher" Width="170px">
                                                        <Image Url="~/COOPERP/images/printer.png">
                                                        </Image>
                                                    </dx:ASPxButton>
                                                </td>
                                                <td align="right">
                                                    <dx:ASPxButton ID="cmdCancel" runat="server" Text="Cancel Voucher" 
                                                        Width="170px">
