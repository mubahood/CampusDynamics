...
public partial class UserControls_Accounts_ReceiptDetails : System.Web.UI.UserControl
{
    ...
    protected void cmdPreview_Click1(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string CRParticulars = txtParticulars.Text + " by " + txtPayee.Text;
            ...
            if (txtStatus.Text == "New")
            {
                lbl_msg.Text = Acc.NewVoucherEntry(int.Parse(lbl_VoucherNo.Text),  txtPayee.Value.ToString(),
                    txtLedgerType.Text, DRParticulars, txtBankAccount.Value.ToString(), "Chart Account", CRParticulars, long.Parse(txtAmount.Text.Replace(",", "")),
                    0, DateTime.Parse(txtDate.Text));
            }
