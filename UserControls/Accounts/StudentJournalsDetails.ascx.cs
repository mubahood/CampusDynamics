...
public partial class UserControls_Accounts_StudentJournalsDetails : System.Web.UI.UserControl
{
    ...
    {
        if (txtPayeeCategory.Text == "Chart Account")
        {
            txtSearch.Text = "Chart Account";
