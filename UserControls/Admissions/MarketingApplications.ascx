<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MarketingApplications.ascx.cs" Inherits="UserControls_Admissions_applications" %>
...
<dx:PanelContent runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxComboBox ID="txtStatus" runat="server" SelectedIndex="0" Width="250px" Height="35px" AutoPostBack="True">
                                                    ...
                                                    <Items>
                                                        <dx:ListEditItem Text="Pending" Value="Pending" Selected="True" />
	...
	callback_applications.PerformCallback(&quot;AddApplicant&quot;);
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <dx:ASPxButton ID="cmdNew" runat="server" AutoPostBack="False" Height="35px" Text="Accept Application" Width="250px" OnClick="cmdNew_Click" Enabled="False">
                                                    <ClientSideEvents Click="function(s, e) {
...
lp_loading.Show();
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>
                                                <dx:ASPxButton ID="ASPxButton1" runat="server" Height="35px" OnClick="ASPxButton1_Click" Text="Reject Application" Width="250px" Enabled="False">
