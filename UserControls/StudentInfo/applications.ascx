...
<dx:PanelContent runat="server">
	...
	callback_applications.PerformCallback(&quot;EntryYearChange&quot;);
                                            ...
                                            <td>
                                                <dx:ASPxComboBox ID="txtIntake" runat="server" SelectedIndex="0" Width="250px" Height="35px">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	callback_applications.PerformCallback(&quot;EntryYearChange&quot;);
}" />
                                                    <Items>
	...
	callback_applications.PerformCallback(&quot;EntryYearChange&quot;);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxComboBox ID="txtProg" runat="server" DataSourceID="dsProgrammes" DropDownWidth="600px" IncrementalFilteringMode="Contains" TextField="progname" TextFormatString="{0}-{1}" ValueField="progcode" Width="250px" Height="35px">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	callback_applications.PerformCallback(&quot;EntryYearChange&quot;);
}" />
                                                    <Columns>
	...
	callback_applications.PerformCallback(&quot;AddApplicant&quot;);
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td>
                                                <dx:ASPxButton ID="cmdAssignHall" runat="server" Height="35px" OnClick="cmdAssignHall_Click" Text="Assign Hall" Width="250px">
                                                    <ClientSideEvents Click="function(s, e) {
                                ...
                                <td colspan="2">
                                    <dx:ASPxGridView ID="gv_ApplicantInfo" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvapplicants" DataSourceID="ds_ApplicantInfo" KeyFieldName="stud_entry_no" OnCustomErrorText="gv_ApplicantInfo_CustomErrorText" OnInitNewRow="gv_ApplicantInfo_InitNewRow" Width="100%" OnHtmlDataCellPrepared="gv_ApplicantInfo_HtmlDataCellPrepared" OnRowInserting="gv_ApplicantInfo_RowInserting">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Name" FieldName="stud_name" ShowInCustomizationForm="True" VisibleIndex="7">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataDateColumn Caption="Birth Date" FieldName="stud_birthdate" ShowInCustomizationForm="True" Visible="False" VisibleIndex="10">
                                                <PropertiesDateEdit DisplayFormatInEditMode="True" DisplayFormatString="{0:dd-MMM-yyyy}" Height="35px">
                                                </PropertiesDateEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="Phone No" FieldName="stud_phone" ShowInCustomizationForm="True" VisibleIndex="26" Width="150px">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Physical Address" FieldName="stud_phy_address" ShowInCustomizationForm="True" Visible="False" VisibleIndex="22">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="E-mail" FieldName="stud_email" ShowInCustomizationForm="True" VisibleIndex="27" Width="200px">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Spouse Name" FieldName="spouse_name" ShowInCustomizationForm="True" Visible="False" VisibleIndex="17">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Spouse Contacts" FieldName="spouse_contacts" ShowInCustomizationForm="True" Visible="False" VisibleIndex="19">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Post Box" FieldName="post_box" ShowInCustomizationForm="True" Visible="False" VisibleIndex="21">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Home District" FieldName="home_district" ShowInCustomizationForm="True" Visible="False" VisibleIndex="25">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Occupation" FieldName="stud_occupation" ShowInCustomizationForm="True" Visible="False" VisibleIndex="28">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Spouse Occupation" FieldName="spouseOccupation" ShowInCustomizationForm="True" Visible="False" VisibleIndex="18">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Title" FieldName="title" ShowInCustomizationForm="True" Visible="False" VisibleIndex="5">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Disabilities" FieldName="physicalDisability" ShowInCustomizationForm="True" Visible="False" VisibleIndex="20">
                                                <PropertiesTextEdit Height="35px">
                                                </PropertiesTextEdit>
                                                <EditFormSettings Visible="True" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Registration No" FieldName="stud_reg_no" ShowInCustomizationForm="True" VisibleIndex="6" Width="150px">
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Study Campus" FieldName="stud_campus" ShowInCustomizationForm="True" Visible="False" VisibleIndex="4">
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Gender" FieldName="stud_sex" ShowInCustomizationForm="True" VisibleIndex="9" Width="100px">
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Marital Status" FieldName="stud_mar_stat" ShowInCustomizationForm="True" Visible="False" VisibleIndex="12">
                                                <PropertiesComboBox Height="35px">
                                                    <Items>
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Nationality" FieldName="stud_nationality" ShowInCustomizationForm="True" Visible="False" VisibleIndex="14">
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Religion" FieldName="stud_religion" ShowInCustomizationForm="True" Visible="False" VisibleIndex="16">
                                                <PropertiesComboBox Height="35px">
                                                    <Items>
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Residence Country" FieldName="residence_country" ShowInCustomizationForm="True" Visible="False" VisibleIndex="24">
                            ...
                            <tr>
                                <td colspan="2" class="auto-style1">
                                    ...
                                    <asp:ObjectDataSource ID="ds_lettertemplates" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="Getadmissionletters" TypeName="admission_dataTableAdapters.acad_admissionlettersTableAdapter" UpdateMethod="Update">
                                        <DeleteParameters>
                                        ...
                                        <ContentCollection>
                                            <dx:PopupControlContentControl runat="server">
                                                <table class="style1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dx:ASPxComboBox ID="txtSession" runat="server" Height="35px" SelectedIndex="0" Width="100%">
                                                                <ClientSideEvents SelectedIndexChanged="function(s, e) {
	}" />
                                                                <Items>
