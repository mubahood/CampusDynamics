...
public partial class COOPERP_StudentInfo_StudentEditor : System.Web.UI.UserControl
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["reg"] = gvStudentInfo.GetRowValues(gvStudentInfo.FocusedRowIndex, "regno");
        Session["stud_name"] = gvStudentInfo.GetRowValues(gvStudentInfo.FocusedRowIndex, "stud_name");
