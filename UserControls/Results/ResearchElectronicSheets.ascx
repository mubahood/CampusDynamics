<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResearchElectronicSheets.ascx.cs" Inherits="UserControls_Results_ResearchElectronicSheets" %>
<style type="text/css">
    .style1
    {
        width: 100%;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="style1">
                    ...
                    <td>
                        <dx:ASPxGridView ID="gvMarksheetInfo" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvMarksheetInfo" DataSourceID="dsMarksheetInfo" KeyFieldName="ID" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Details" ShowInCustomizationForm="True" VisibleIndex="28" Width="40px">
                                    <DataItemTemplate>
                ...
                <tr>
                    <td>
                        <asp:ObjectDataSource ID="dsMarksheetInfo" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetResearchSheetsByFaculty" TypeName="ResultsDataTableAdapters.acad_researchexamsettingsTableAdapter" InsertMethod="Insert" UpdateMethod="Update">
                            <DeleteParameters>
                            ...
                            <InsertParameters>
                                ...
                                <asp:Parameter Name="InternalExaminerRatio" Type="Double" />
                                <asp:Parameter Name="ExternalExaminerRatio" Type="Double" />
                ...
                <tr>
                    <td>
                        <dx:ASPxPopupControl ID="pop_messagebox" runat="server" CloseAction="CloseButton" DisappearAfter="10" HeaderText="Campus Dynamics Version 1.0" Height="100px" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="300px">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table class="style1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dx:ASPxComboBox ID="txtNewStatus" runat="server" ReadOnly="True" SelectedIndex="1" Width="90%">
                                                                <ClientSideEvents TextChanged="function(s, e) {
	gvMarksheetInfo.Refresh();
}" />
                                                                <Items>
                                                                    <dx:ListEditItem Text="NEW" Value="2" />
                                                                    <dx:ListEditItem Selected="True" Text="SUBMITTED" Value="SUBMITTED" />
                                                                    <dx:ListEditItem Text="APPROVED" Value="APPROVED" />
                                                                    <dx:ListEditItem Text="CAPTURED" Value="CAPTURED" />
                                                                    <dx:ListEditItem Text="REJECTED" Value="REJECTED" />
