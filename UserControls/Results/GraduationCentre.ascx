                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl runat="server">
                                    <table class="style1">
                                        ...
                                        <tr>
                                            <td>
                                                <dx:ASPxComboBox ID="txtEntryMethod" runat="server" DataSourceID="ds_entrytypes" Height="35px" SelectedIndex="0" TextField="EntryMethod" TextFormatString="{0}" ValueField="EntryMethod" Width="100%">
                                                    <Columns>
