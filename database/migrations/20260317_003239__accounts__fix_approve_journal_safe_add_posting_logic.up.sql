-- Migration: fix_approve_journal_safe_add_posting_logic
-- Logical database: accounts
-- Generated: 2026-03-17T00:32:39
-- ============================================================================
-- FIX: fin_ApproveJournal_Safe was validation-only — missing all posting logic.
-- The original fin_ApproveJournal copied entries from fin_journal_details to
-- fin_ledger, generated GL_VoucherNo, handled forex, etc.
-- This migration recreates the SP with BOTH proper validation AND posting logic.
-- ============================================================================
        ...
        ELSE
            ...
            ELSE
                ...
                ELSE
                    ...
                    -- (Restored from original fin_ApproveJournal)
                    -- =========================================================
                    ...
                    WHERE jd.journal_no = p_journal_no
                    ...
                    INNER JOIN fin_journalnumbers j ON d.journal_no = j.JournalNo
                    WHERE d.journal_no = p_journal_no;
