<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentVoucher.aspx.cs" Inherits="UserControls_Accounts_PaymentVoucher" %>
    ...
    <table class="dx-justification">
        <tr>
            <td>
                <table class="dx-justification">
                    <tr>
                        <td class="auto-style1">Voucher Type:</td>
                        ...
                        <td class="auto-style3">
                            <dx:ASPxButton ID="cmdPrintJournal" runat="server" Height="35px" OnClick="cmdPrintJournal_Click" Text="Print Voucher" Width="170px">
            ...
            <td>
                <dx:ASPxGridView ID="gvParticulars" runat="server" AutoGenerateColumns="False" DataSourceID="dsLatestJournal" KeyFieldName="JournalNo" OnCustomErrorText="gvParticulars_CustomErrorText" OnDataBound="gvParticulars_DataBound" OnHtmlDataCellPrepared="gvParticulars_HtmlDataCellPrepared" Width="100%" OnRowUpdating="gvParticulars_RowUpdating">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Created By" FieldName="Teller" ShowInCustomizationForm="True" VisibleIndex="2">
                        ...
                        <dx:GridViewDataTextColumn Caption="GL Voucher No" FieldName="GL_VoucherNo" ShowInCustomizationForm="True" VisibleIndex="6" Width="80px">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataComboBoxColumn Caption="Currency" FieldName="journal_currency" ShowInCustomizationForm="True" VisibleIndex="7">
                        ...
                        <dx:GridViewDataTextColumn Caption="Forex Rate" FieldName="forex_rate" ShowInCustomizationForm="True" VisibleIndex="8">
                            ...
                            <table class="auto-style5">
                                <tr>
                                    <td  colspan="2" align="Centre" style="text-align: center">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" ForeColor="Red" Text="PAYEE DETAILS:">
                                        </dx:ASPxLabel>
                                        <br />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style6">Payee Name:</td>
                                    <td>
                                        <dx:ASPxComboBox ID="txtPayees" runat="server" DataSourceID="dsAccounts" SelectedIndex="0" TextField="AccountName" TextFormatString="{1}" ValueField="AccountCode" Width="250px" Height="35px">
                                            <Columns>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxRadioButtonList ID="rb_payeetype" runat="server" RepeatDirection="Horizontal" SelectedIndex="0" Width="250px">
                                            <Items>
                                                <dx:ListEditItem Selected="True" Text="Single Payee" Value="Single Payee" />
                                                <dx:ListEditItem Text="Multiple Payee" Value="Multiple Payee" />
                                            </Items>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtAccount" runat="server" DataSourceID="dsPayeeAccounts" Height="35px" SelectedIndex="0" TextField="accountName" TextFormatString="{1}" ValueField="accountCode" Width="250px">
                                            <Columns>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox ID="txtAmount" runat="server" NullText="Amount eg 100,000" OnTextChanged="txtSearch_TextChanged" Width="250px" Height="35px">
                                    ...
                                    <td class="auto-style6" colspan="2">
                                        <asp:ObjectDataSource ID="dsAccounts" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CoopERPDataTableAdapters.fin_GetJournalAccountsTableAdapter">
                                            <SelectParameters>
                                                ...
                                                <asp:Parameter DefaultValue="Payments" Name="typ" Type="String" />
                                            </SelectParameters>
                                        </asp:ObjectDataSource>
