<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentReceipt.aspx.cs" Inherits="COOPERP_accounts_StudentReceipt" %>
...
<dx:PanelContent ID="PanelContent1" runat="server">
    <table class="dx-justification">
            ...
            <td class="auto-style8">
                <dx:ASPxGridView ID="gvParticulars" runat="server" AutoGenerateColumns="False" DataSourceID="dsLatestJournal" KeyFieldName="JournalNo" OnDataBound="gvParticulars_DataBound" Width="100%" OnCustomErrorText="gvParticulars_CustomErrorText" OnHtmlDataCellPrepared="gvParticulars_HtmlDataCellPrepared">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Teller" ShowInCustomizationForm="True" VisibleIndex="2" Caption="Created By">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="PostStatus" ShowInCustomizationForm="True" VisibleIndex="3">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Type" FieldName="journalType" ShowInCustomizationForm="True" VisibleIndex="4" Width="200px">
                            <EditFormSettings Visible="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="Date" FieldName="journalDate" ShowInCustomizationForm="True" VisibleIndex="5">
                        ...
                        <dx:GridViewDataTextColumn Caption="Memo" FieldName="journalParticulars" ShowInCustomizationForm="True" VisibleIndex="8" Width="300px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="voucherType" ShowInCustomizationForm="True" Visible="False" VisibleIndex="9">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="GL_VoucherNo" ShowInCustomizationForm="True" VisibleIndex="6" Caption="GL Voucher No" Width="80px">
                            <EditFormSettings Visible="False" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Currency" FieldName="journal_currency" ShowInCustomizationForm="True" VisibleIndex="7" Width="25px">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                </dx:ASPxGridView>
            </td>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="gvDetails" runat="server" AutoGenerateColumns="False" DataSourceID="dsJournalDetails" KeyFieldName="TID" Width="100%" OnRowUpdated="gvDetails_RowUpdated" OnCustomErrorText="gvDetails_CustomErrorText">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Code" FieldName="accountcode" ShowInCustomizationForm="True" VisibleIndex="1" Width="200px">
                        </dx:GridViewDataTextColumn>
        ...
        <tr>
            <td>
                <asp:ObjectDataSource ID="dsLatestJournal" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetLatestJournal" TypeName="CoopERPDataTableAdapters.fin_journalnumbersTableAdapter" UpdateMethod="Update">
                    <DeleteParameters>
        ...
        <tr>
            <td>
                <dx:ASPxPopupControl ID="pop_NewDetail" runat="server" CloseAction="CloseButton" HeaderText="New Receipt Detail" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="400px">
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                            <table class="auto-style5">
                                <tr>
                                    <td  colspan="2" align="Centre" style="text-align: center">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" ForeColor="Red" Text="STUDENT DETAILS:">
                                        </dx:ASPxLabel>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style6" colspan="2">
                                        <dx:ASPxImage ID="ASPxImage1" runat="server" ImageUrl="~/COOPERP/images/hor_line.png"  ShowLoadingImage="True" Width="100%">
                                        </dx:ASPxImage>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style6">Student Search:</td>
                                    <td>
                                        <dx:ASPxTextBox ID="txtSearch" runat="server" AutoPostBack="True" NullText="Student Name | Reg No" OnTextChanged="txtSearch_TextChanged" Width="250px" Height="35px">
	...
	lp_details.Show();
                                ...
                                <tr>
                                    <td colspan="2" style="text-align: center">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Font-Bold="True" ForeColor="Red" Text="BANK DETAILS:">
                                        </dx:ASPxLabel>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style6" colspan="2">
                                        <dx:ASPxImage ID="ASPxImage2" runat="server" ImageUrl="~/COOPERP/images/hor_line.png"  ShowLoadingImage="True" Width="100%">
                                        </dx:ASPxImage>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style6">Paid Thru:</td>
                                    <td>
                                        <dx:ASPxComboBox ID="txtPayee" runat="server" AutoPostBack="True" DataSourceID="dsPayeeAccounts" Height="35px" SelectedIndex="0" TextField="accountName" TextFormatString="{1}" ValueField="accountCode" Width="250px">
                                            <Columns>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox ID="txtAmount" runat="server" AutoPostBack="True" NullText="Amount eg 100,000" OnTextChanged="txtSearch_TextChanged" Width="250px" Height="35px">
                                            <ClientSideEvents TextChanged="function(s, e) {
	lp_details.Show();
}" />
                                        </dx:ASPxTextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="AddNewItem" runat="server" OnClick="AddNewItem_Click" Text="Add Details" Width="250px" Height="35px">
