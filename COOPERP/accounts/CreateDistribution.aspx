                ...
                <table class="dx-justification">
                    <tr>
                        ...
                        <td class="auto-style4">
                            <dx:ASPxButton ID="cmdCreateNew" runat="server" OnClick="cmdCreateNew_Click" Text="Create New" Width="170px" Height="35px">
                        ...
                        <dx:PopupControlContentControl runat="server">
                            <table class="auto-style5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtAccount" runat="server" DataSourceID="dsAccounts" Height="35px" SelectedIndex="0" TextField="AccountName" TextFormatString="{1}" ValueField="AccountCode" Width="250px">
                                            <Columns>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtTransactionType" runat="server" Enabled="False" Height="35px" SelectedIndex="1" Width="250px">
                                            <Items>
                                                <dx:ListEditItem Text="CR" Value="CR" />
                                                <dx:ListEditItem Selected="True" Text="DR" Value="DR" />
                                            </Items>
                                        </dx:ASPxComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="AddNewItem" runat="server" Height="35px" OnClick="AddNewItem_Click" Text="Add Details" Width="250px">
