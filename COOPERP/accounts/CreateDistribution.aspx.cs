...
public partial class COOPERP_accounts_CreateDistribution : System.Web.UI.Page
{
    ...
    protected void AddNewItem_Click(object sender, EventArgs e)
    {
        ...
        txtAccount.SelectedItem.GetValue("category").ToString(), gvParticulars.GetRowValues(0, "journalParticulars").ToString(), txtTransactionType.Text);
        gvDetails.DataBind();
    }
