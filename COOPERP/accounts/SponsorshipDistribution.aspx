...
<dx:PanelContent ID="PanelContent1" runat="server">
    <table class="dx-justification">
            ...
            <td>
                <dx:ASPxGridView ID="gvParticulars" runat="server" AutoGenerateColumns="False" DataSourceID="dsLatestJournal" KeyFieldName="JournalNo" OnDataBound="gvParticulars_DataBound" Width="100%" OnCustomErrorText="gvParticulars_CustomErrorText" OnHtmlDataCellPrepared="gvParticulars_HtmlDataCellPrepared">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="Date" FieldName="journalDate" ShowInCustomizationForm="True" VisibleIndex="5" Width="150px">
        ...
        <tr>
            <td>
                <dx:ASPxButton ID="cmdAddItem" runat="server" OnClick="cmdAddItem_Click" Text="Add Distribution" Width="170px" Height="35px">
                    <Image Url="~/COOPERP/images/tick-button.png">
                    </Image>
                </dx:ASPxButton>
                <dx:ASPxButton ID="cmdClearDistro" runat="server" Height="35px" OnClick="cmdClearDistro_Click" Text="Clear Distribution" Width="170px">
        ...
        <tr>
            <td>
                ...
                <asp:ObjectDataSource ID="dsJournalDetails" runat="server" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetJournalDetails" TypeName="CoopERPDataTableAdapters.fin_ledgerTableAdapter" UpdateMethod="UpdateJournalDetails">
                    <InsertParameters>
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                            <table class="auto-style5">
                                ...
                                <tr>
                                    <td class="auto-style7">Account Name:</td>
                                    <td>
                                        <dx:ASPxComboBox ID="txtAccount" runat="server" DataSourceID="dsAccounts" SelectedIndex="0" TextField="AccountName" TextFormatString="{1}" ValueField="AccountCode" Width="100%" Height="35px">
                                            <Columns>
                                ...
                                <tr>
                                    <td class="auto-style7">CR|DR</td>
                                    <td>
                                        <dx:ASPxComboBox ID="txtTransactionType" runat="server" SelectedIndex="1" Width="100%" Enabled="False" Height="35px">
                                            <Items>
                                                <dx:ListEditItem Text="CR" Value="CR" />
                                                <dx:ListEditItem Text="DR" Value="DR" Selected="True" />
                                            </Items>
                                        </dx:ASPxComboBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtAcademicYear" runat="server" Height="35px" Width="100%">
                                            <Paddings PaddingLeft="5px" />
                                        </dx:ASPxComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtTerm" runat="server" Height="35px" SelectedIndex="0" Width="100%">
                                            <Items>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="AddNewItem" runat="server" Height="35px" OnClick="AddNewItem_Click" Text="Create Distribution" Width="100%">
