<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SponsorReceipt.aspx.cs" Inherits="COOPERP_accounts_SponsorReceipt" %>
                            ...
                            <table class="auto-style5">
                                <tr>
                                    <td  colspan="2" align="Centre" style="text-align: center">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" ForeColor="Red" Text="SPONSOR DETAILS:">
                                        </dx:ASPxLabel>
                                        <br />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="auto-style6">Sponsor Name:</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="txtPayee" runat="server" DataSourceID="dsPayeeAccounts" Height="35px" SelectedIndex="0" TextField="accountName" TextFormatString="{1}" ValueField="accountCode" Width="250px">
                                            <Columns>
                                    ...
                                    <td class="auto-style6" colspan="2">
                                        <asp:ObjectDataSource ID="dsAccounts" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CoopERPDataTableAdapters.fin_GetJournalAccountsTableAdapter">
                                            <SelectParameters>
                                                ...
                                                <asp:Parameter DefaultValue="Sponsor" Name="typ" Type="String" />
                                            </SelectParameters>
                                        </asp:ObjectDataSource>
