-- ============================================================================
-- acad_CreateTranscript — ORIGINAL (pre-2026-07-01), kept for ROLLBACK only.
-- Run this to revert the per-block academic-year normalisation fix.
-- (This version leaves the block "Academic Year" as the individual course's acad,
--  which can be wrong after the curriculum re-map — that is the bug that was fixed.)
-- ============================================================================
