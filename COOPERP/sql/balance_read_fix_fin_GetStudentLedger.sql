-- ============================================================================
-- FIX B applied to fin_GetStudentLedger — campus_dynamics_accounts (2026-06-25)
-- Waive the particulars match for CREDITS (Payment/Waiver) so migration/imported
-- ledger rows (whose particulars = student NAME) no longer fail to dedup and
-- double-count the payment. Bills keep the strict particulars match.
-- Backup/rollback: _backup_fin_GetStudentLedger_20260625.sql
-- Only changed line:
