...
public partial class COOPERP_NewScreens_UnlocatedNewProgrammeCourses : System.Web.UI.Page
{
    ...
    private void LoadStats()
    {
        string sql = @"
            ...
            WHERE UPPER(IFNULL(status,'Active'))='ACTIVE'
              AND (IFNULL(is_lecturere_assigned,'No')='No' OR IFNULL(lecturer_id,0)=0)";
