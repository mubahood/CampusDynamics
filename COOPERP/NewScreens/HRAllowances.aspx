...
/* Batch toolbar */
.ct-batch-toolbar{display:none;align-items:center;gap:8px;flex-wrap:wrap;padding:8px 14px;background:#f0fff4;border-top:1px solid #b2dfdb;border-bottom:2px solid #28a745;}
.ct-batch-info{display:flex;align-items:center;gap:5px;font-size:11px;color:#155724;white-space:nowrap;}
.ct-batch-info strong{font-size:13px;font-weight:700;color:#155724;}
.ct-batch-sep{width:1px;height:24px;background:#a5d6a7;margin:0 2px;flex-shrink:0;}
.ct-row-check{cursor:pointer;width:14px;height:14px;accent-color:#28a745;vertical-align:middle;}
...
.hr-modal__header{display:flex;align-items:center;justify-content:space-between;padding:11px 16px;background:#28a745;color:#fff;}
...
.hr-input:focus,.hr-select:focus{outline:none;border-color:#28a745;}
...
/* Section label */
.hr-section-label{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#28a745;border-bottom:1px solid #d4edda;padding-bottom:4px;margin:14px 0 10px;}
...
.batch-preview__item{background:#d4edda;color:#155724;font-size:10px;font-weight:600;padding:3px 8px;border:1px solid #c3e6cb;}
...
<div class="pr-page-header">
    <div class="pr-page-header__left">
        ...
        <div>
            <div class="pr-page-title">Payroll Allowance Records</div>
            <div class="pr-page-sub">Transport, housing, acting and other ad-hoc allowances scheduled for specific payroll periods</div>
        </div>
    </div>
...
<div class="ct-stats">
    ...
    <div class="ct-stat ct-stat--green">
        <div class="ct-stat__icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#28a745" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        </div>
        <div>
    ...
    <div class="ct-stat ct-stat--blue">
        <div class="ct-stat__icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#174DA4" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
        </div>
        <div>
...
<div class="ct-batch-toolbar" id="batchToolbar">
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#155724" stroke-width="2"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
...
<dx:ASPxGridView ID="gvAllowances" runat="server" Width="100%" ClientInstanceName="gvAllowances"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="allowance_type" Caption="Allowance Type" Width="155">
            ...
            <DataItemTemplate>
                <span class="pr-type"><%# Eval("allowance_type") %></span>
            </DataItemTemplate>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="to_add_month" Caption="Month" Width="100">
            ...
            <DataItemTemplate>
                <span class="pr-period"><%# Eval("to_add_month") %></span>
            </DataItemTemplate>
        </dx:GridViewDataComboBoxColumn>
...
<div class="hr-modal-overlay" id="addAllowanceModal">
    <div class="hr-modal">
        ...
        <div class="hr-modal__body">
            ...
            <div class="hr-form-row">
                <div class="hr-form-group hr-form-group--full">
                    <label class="hr-label">Allowance Type <span>*</span></label>
        ...
        <div class="hr-modal__footer">
            ...
            <asp:Button ID="btnAddAllowance" runat="server" Text="Save Allowance" CssClass="hr-btn hr-btn--success hr-btn--sm" OnClick="btnAddAllowance_Click" />
        </div>
    </div>
</div>
...
<div class="hr-modal-overlay" id="batchAllowanceModal">
    <div class="hr-modal hr-modal--wide">
        ...
        <div class="hr-modal__body">
            ...
            <div class="hr-form-row">
                <div class="hr-form-group">
                    <label class="hr-label">Amount per Month (UGX) <span>*</span></label>
                    <asp:TextBox ID="txtBatchAmount" runat="server" CssClass="hr-input" TextMode="Number" Text="0" />
                </div>
                <div class="hr-form-group">
                    <label class="hr-label">Number of Months <span>*</span></label>
        ...
        <div class="hr-modal__footer">
            ...
            <asp:Button ID="btnBatchCreate" runat="server" Text="Create Records" CssClass="hr-btn hr-btn--success hr-btn--sm" OnClick="btnBatchCreate_Click" />
        </div>
    </div>
</div>
...
function openBatchModal(){
    document.getElementById('batchAllowanceModal').style.display='flex';
