...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- ── Stat tiles ────────────────────────────────────────── -->
    <div class="pc-stats">
        <div class="pc-stat"><div class="pc-stat__label">Total Assignments</div><div class="pc-stat__value"><asp:Literal ID="litTotal" runat="server" Text="0" /></div></div>
    ...
    <div class="pc-card">
        <div class="pc-card__head">
            <div class="pc-card__head-main">
                <div class="pc-card__title">Course Assignments <asp:Literal ID="litRequestAlert" runat="server" /></div>
...
function importStep1_Discover() {
    ...
    fetch('NewProgrammeCourses.aspx/ImportStep_DiscoverCandidates', {
        method: 'POST',
...
function importStep4_Confirm() {
    ...
    fetch('NewProgrammeCourses.aspx/ImportStep_ExecuteAssignments', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json; charset=utf-8' },
...
function submitRequestDecision(){
    ...
    fetch('NewProgrammeCourses.aspx/ProcessAllocationRequestDecision',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
...
function loadLecturerFilterOptions(){
    ...
    if(!filterVal) return;
    fetch('NewProgrammeCourses.aspx/GetLecturerFilterOptions',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
        body:'{}'
    })
