<%@ Page Language="C#" MasterPageFile="~/COOPERP/NewScreens/SidebarMaster.master" AutoEventWireup="true" CodeFile="PendingExamMarksController.aspx.cs" Inherits="COOPERP_NewScreens_PendingExamMarksController" Title="Pending Exam Marks Controller - Admin" %>
...
<div class="pm-card">
	<div class="pm-card__head">
		<div>
			<div class="pm-card__title">Pending Exam Marks Controller</div>
			<div class="pm-muted">Marks where exam scores have not yet been submitted</div>
		</div>
	</div>
...
function goWithQuery(params){ var query = new URLSearchParams(); Object.keys(params).forEach(function(k){ if(params[k]!==undefined && params[k]!==null) query.set(k, params[k]); }); window.location.href='PendingExamMarksController.aspx?'+query.toString(); }
