...
public partial class COOPERP_NewScreens_MarkCaptureController : Page
{
    private const string STAGE = "CAPTURE";
    ...
    [WebMethod(EnableSession = true)] public static string Init() { return StageConsoleShared.Init("CAPTURE"); }
    [WebMethod(EnableSession = true)] public static string Stats() { return StageConsoleShared.Stats("CAPTURE"); }
    [WebMethod(EnableSession = true)] public static string Browse(string year, string sem, string prog, string q, int page, int pageSize, bool? failedOnly) { return StageConsoleShared.Browse("CAPTURE", year, sem, prog, q, page, pageSize, failedOnly ?? false); }
    [WebMethod(EnableSession = true)] public static string CreateAndPreview(string prog, int yos, string acadYear, int sem, bool all, string notes, string failMode) { return StageConsoleShared.CreateAndPreview("CAPTURE", prog, yos, acadYear, sem, all, notes, failMode); }
    ...
    [WebMethod(EnableSession = true)] public static string Progress(int recordId) { return StageConsoleShared.Progress("CAPTURE", recordId); }
