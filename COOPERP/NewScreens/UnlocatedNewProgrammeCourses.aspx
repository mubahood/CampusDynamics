<%@ Page Language="C#" MasterPageFile="~/COOPERP/NewScreens/SidebarMaster.master" AutoEventWireup="true" CodeFile="UnlocatedNewProgrammeCourses.aspx.cs" Inherits="COOPERP_NewScreens_UnlocatedNewProgrammeCourses" Title="Unlocated Programme Courses - Campus Dynamics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- ── Stat tiles ────────────────────────────────────────── -->
    <div class="pc-stats">
        <div class="pc-stat"><div class="pc-stat__label">Unlocated Active</div><div class="pc-stat__value"><asp:Literal ID="litTotal" runat="server" Text="0" /></div></div>
    ...
    <div class="pc-card">
        <div class="pc-card__head">
            <div class="pc-card__head-main">
                <div class="pc-card__title">Unlocated Active Courses <asp:Literal ID="litRequestAlert" runat="server" /></div>
            </div>
...
function importStep1_Discover() {
    ...
    fetch('UnlocatedNewProgrammeCourses.aspx/ImportStep_DiscoverCandidates', {
        method: 'POST',
...
function importStep4_Confirm() {
    ...
    fetch('UnlocatedNewProgrammeCourses.aspx/ImportStep_ExecuteAssignments', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json; charset=utf-8' },
...
function resetFilters(){
    ...
    filterPcTable('');
    window.location.href=window.location.pathname+'?asg=No';
}
...
function submitRequestDecision(){
    ...
    fetch('UnlocatedNewProgrammeCourses.aspx/ProcessAllocationRequestDecision',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
...
function loadLecturerFilterOptions(){
    ...
    if(!filterVal) return;
    fetch('UnlocatedNewProgrammeCourses.aspx/GetLecturerFilterOptions',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
        body:'{}'
    })
...
function submitBatchAssignment(){
    ...
    fetch('UnlocatedNewProgrammeCourses.aspx/BatchAssignLecturers',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
