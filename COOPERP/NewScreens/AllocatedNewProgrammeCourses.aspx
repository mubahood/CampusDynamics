<%@ Page Language="C#" MasterPageFile="~/COOPERP/NewScreens/SidebarMaster.master" AutoEventWireup="true" CodeFile="AllocatedNewProgrammeCourses.aspx.cs" Inherits="COOPERP_NewScreens_AllocatedNewProgrammeCourses" Title="Allocated Programme Courses - Campus Dynamics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- ── Stat tiles ────────────────────────────────────────── -->
    <div class="pc-stats">
        <div class="pc-stat"><div class="pc-stat__label">Allocated Active</div><div class="pc-stat__value"><asp:Literal ID="litTotal" runat="server" Text="0" /></div></div>
    ...
    <div class="pc-card">
        <div class="pc-card__head">
            <div class="pc-card__head-main">
                <div class="pc-card__title">Allocated Active Courses <asp:Literal ID="litRequestAlert" runat="server" /></div>
            </div>
...
function importStep1_Discover() {
    ...
    fetch('AllocatedNewProgrammeCourses.aspx/ImportStep_DiscoverCandidates', {
        method: 'POST',
...
function importStep4_Confirm() {
    ...
    fetch('AllocatedNewProgrammeCourses.aspx/ImportStep_ExecuteAssignments', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json; charset=utf-8' },
...
function resetFilters(){
    ...
    filterPcTable('');
    window.location.href=window.location.pathname+'?asg=Yes';
}
...
function submitRequestDecision(){
    ...
    fetch('AllocatedNewProgrammeCourses.aspx/ProcessAllocationRequestDecision',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
...
function loadLecturerFilterOptions(){
    ...
    if(!filterVal) return;
    fetch('AllocatedNewProgrammeCourses.aspx/GetLecturerFilterOptions',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
        body:'{}'
    })
...
function submitBatchAssignment(){
    ...
    fetch('AllocatedNewProgrammeCourses.aspx/BatchAssignLecturers',{
        method:'POST',
        headers:{'Content-Type':'application/json; charset=utf-8'},
