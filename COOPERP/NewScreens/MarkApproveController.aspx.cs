...
public partial class COOPERP_NewScreens_MarkApproveController : Page
{
    private const string STAGE = "APPROVE";
    ...
    [WebMethod(EnableSession = true)] public static string Init() { return StageConsoleShared.Init("APPROVE"); }
    [WebMethod(EnableSession = true)] public static string Stats() { return StageConsoleShared.Stats("APPROVE"); }
    [WebMethod(EnableSession = true)] public static string Browse(string year, string sem, string prog, string q, int page, int pageSize, bool? failedOnly) { return StageConsoleShared.Browse("APPROVE", year, sem, prog, q, page, pageSize, failedOnly ?? false); }
