<%@ Page Language="C#" MasterPageFile="~/COOPERP/NewScreens/SidebarMaster.master" AutoEventWireup="true" CodeFile="MarkPublishController.aspx.cs" Inherits="COOPERP_NewScreens_MarkPublishController" Title="Publish Results (Senate) - Campus Dynamics" %>
...
<div class="sc-wrap">
  <div class="sc-head">
    <div class="sc-head__top">
      <div>
        <div class="sc-title">Publish Results &middot; Examination Board / Senate</div>
        <div class="sc-flow">Advance marks from <b id="sc-from-label">…</b> &rarr; <b id="sc-to-label">…</b> &middot; this writes FINAL results &amp; recomputes GPA/CGPA. Students then see results.</div>
      </div>
  ...
  <div class="sc-actionbar">
    <button type="button" class="sc-btn sc-btn--lg" id="sc-launch" onclick="SC.openWizard()">
      ...
      Publish results&hellip;</button>
    <span class="sc-actionbar__hint">Select approved marks, preview, then publish FINAL results (writes to records &amp; recomputes GPA).</span>
    <span class="sc-cantact" id="sc-cantact" style="display:none;">Only administrators / VC (Examination Board) can publish final results.</span>
  </div>
  ...
  <div id="sc-view-queue">
    ...
    <div class="sc-card">
      <div class="sc-toolbar">
        <strong style="font-size:11px;color:#05275C;">Marks awaiting final publish</strong>
...
<div class="sc-modal" id="sc-modal">
  <div class="sc-modal__box">
    <div class="sc-modal__hd"><span>New publish session</span><button type="button" class="sc-modal__x" onclick="SC.closeWizard()">&times;</button></div>
    <div class="sc-modal__bd">
      <div id="sc-wiz-params">
        <p class="sc-wiz-intro">Select what to publish as <b>final results</b>. Leave a field as <em>All</em> to include everything, or tick &ldquo;Everything in my scope&rdquo;. This writes to academic records and recomputes GPA/CGPA.</p>
