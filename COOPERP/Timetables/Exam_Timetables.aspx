...
<dx:ListEditItem Text="AUGUST" Value="AUGUST" />
        ...
        <tr>
            <td>
                ...
                <asp:ObjectDataSource ID="dsCourses" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_CoursesByProgramAndPeriod" TypeName="TimetableDataTableAdapters.acad_programmecoursesTableAdapter" DeleteMethod="Delete" UpdateMethod="Update">
                    <DeleteParameters>
                        <asp:Parameter Name="Original_ID" Type="UInt32" />
                    </DeleteParameters>
                    <SelectParameters>
