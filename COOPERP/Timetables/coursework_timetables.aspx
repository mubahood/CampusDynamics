...
<dx:PanelContent ID="PanelContent1" runat="server">
    ...
    <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Width="100%">
        ...
        <TabPages>
                                            ...
                                            <td>
                                                <table class="style1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="auto-style3">
                                                            <dx:ASPxComboBox ID="txt_entry_year" runat="server" AutoPostBack="True" Height="30px" Width="300px">
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="auto-style3">
                                                            <dx:ASPxButton ID="cmdAddNew" runat="server" Height="35px" OnClick="cmdAddNew_Click" Text="Add Single Course" Width="300px">
            ...
            <dx:TabPage Text="Mark Ratios" ClientVisible="False">
