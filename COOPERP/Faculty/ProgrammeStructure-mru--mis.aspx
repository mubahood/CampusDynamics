                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style6">
                                                    <dx:ASPxButton ID="cmdUpdateCurriculum" runat="server" Height="25px" Text="Change | Refresh Curriculums" ToolTip="Click to Switch Selected Courses to another Curriculum" Width="220px" OnClick="cmdUpdateCurriculum_Click">
                                                            ...
                                                            <dx:PopupControlContentControl runat="server">
                                                                <table class="style1">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dx:ASPxComboBox ID="txt_curriculums_new" runat="server" AutoPostBack="True" DataSourceID="dsOtherCurriculums" DropDownWidth="500px" Height="25px" SelectedIndex="0" TextField="Tittle" TextFormatString="{0}" ValueField="ID" ValueType="System.Int32" Width="250px">
                                                                                <Columns>
                                                                                    <dx:ListBoxColumn FieldName="ID" Visible="False" />
                                                                                    <dx:ListBoxColumn FieldName="Tittle" />
                                                                                </Columns>
                                                                    ...
                                                                    <tr>
                                                                        <td>&nbsp;</td>
                                                                        <td>
                                                                            <dx:ASPxButton ID="cmdChangeCurriculum" runat="server" Height="25px" Text="Update" ToolTip="Click to Switch Selected Courses to the Selected New Curriculum" Width="250px" OnClick="cmdChangeCurriculum_Click">
                                                                                <ClientSideEvents Click="function(s, e) {
e.processOnServer = confirm('Change the Curriculum to which the Selected Course(s) are attached?');
