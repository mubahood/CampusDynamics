...
public class SelfPhotoUpload : IHttpHandler
{
    ...
    // Size limits, format sniffing and the plain-English refusal reasons all live in
    // App_Code/StudentPhotoValidator.cs, shared with the administrator's uploader on
    // PhotoChangeController.aspx. Two copies of this would drift, and the weaker copy
    // would become the way in.
    ...
    public void ProcessRequest(HttpContext ctx)
    {
        ...
        try
        {
            ...
            // Judged by CONTENT, not by name — see StudentPhotoValidator for why, and for
            // the specific reason each refusal carries.
            string why;
            ...
            try
            {
                thumb = im.MakeThumb(original, StudentPhotoValidator.ThumbJpegQuality);
            }
